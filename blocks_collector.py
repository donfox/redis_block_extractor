#######################################################################################################################
#                                                                                                                     
#   File: blocks_collector.py                                                                                         
#   Author: Don Fox                                                                                                   
#   Date: 06/21/2024                                                                                                  
#                                                                                                                     
#   Description:                                                                                                      
#   This script downloads blockchain block files from an online source using RESTful requests and stores them         
#   locally. The names of the collected files are listed in Redis as 'blocks_collected' and written to                
#   'blocks_collector.log'.                                                                                           
#                                                                                                                     
#   Notes:                                                                                                            
#   - The script runs for 60 seconds per execution. Block files are generated periodocally and a request may 
#     occasionally retrieve the same file multiple times so duplicates are ignored.                                                                                
...
log_file = os.path.join(log_dir, 'blocks_collector.log')
